...
open class YesNoPopUp(
    ...
    private val noButton = ClickTextButton("simple-button", skin, "NO", "bold", 80f, !noIsHighlighted).apply {
    ...
    private val yesButton = ClickTextButton("simple-button", skin, "YES", "bold", 80f, !yesIsHighlighted).apply {
        upColor = Colors.gameColor
        downColor = Colors.uiDownColor
        clickRunnable = Runnable {
            this@YesNoPopUp.remove()
